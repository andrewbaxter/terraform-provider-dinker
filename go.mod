...
require (
	github.com/andrewbaxter/dinker v0.1.2
	github.com/containers/image/v5 v5.29.3-0.20240202200346-ffdc507d8924
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20240202231949-45b644fafd01 // indirect
